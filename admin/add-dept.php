...
//echo $rowData[0][0][1];
            ...
            foreach ($rowData as $datum) {
                foreach ($datum as $item) {
                    ...
                    $mDept->save_dept($dept_name, $dept_code, "Admin", $created_date, "null", "null", "null", 1);
                }
            }
                  ...
                  <div class="table-responsive">
                      ...
                      <form action="add-dept.php" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="dept_code" placeholder="Enter department code" name="dept_code">
                          </div>
                      ...
                      <br><br>
                      <h2>Upload department list from xlsx spreadsheet:</h2>
                      ...
                      <p style="color: #05a4cf">[N.B]: File must be in .xlsx format and should contain these field(dept_name, dept_code)</p>
                  </div>
                </div>
