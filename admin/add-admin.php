...
if (!empty($_POST)) {
    ...
    !empty($user_phone) && !empty($user_password) && $user_role !== 0) {
        ...
        $mAdmin->save_admin($user_name, $email, $user_id, $user_role, $user_password, $user_phone, "Admin", $created_date, null, null, true,1);
...
//echo $rowData[0][0][1];
            ...
            foreach ($rowData as $datum) {
                foreach ($datum as $item) {
                    ...
                    $mAdmin->save_admin($full_name, $email, $user_id, $admin_role, $password, $mobile, "Admin", $created_date, "null", "null", "null", 1);
                }
            }
                  ...
                  <div class="table-responsive">
                      ...
                      <form action="add-admin.php" method="post">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="user_id" placeholder="Enter admin ID" name="user_id">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-group" name="admin_role" id="admin_role">
                                  ...
                                  <option value="1" style="background-color: white">Super Admin</option>
                                  <option value="2" style="background-color: white">Admin</option>
                                  <option value="3" style="background-color: white">Data Entry Operator</option>
                              </select>
                          </div>
                          <div class="form-group">
                          ...
                          <p style="color: #05a4cf">[N.B]: File must be in .xlsx format and should contain these field(full_name,email,user_id,admin_role,password,mobile)</p>
                      </form>
                  </div>
                </div>
            <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
